  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="https://placehold.it/60x33"></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
		  ...
		  <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">TV e Áudio <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="busca.php?=Smart">TV Smart</a></li>
            <li><a href="busca.php?=4K">TV 4K</a></li>
            
            <li role="separator" class="divider"></li>
            <li><a href="#">Fone</a></li>
            <li role="separator" ></li>
            <li><a href="#">Dock Station</a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#">contato</a></li>
		  ...
		  <li><a href="formLogon.php"><span class="glyphicon glyphicon-log-in"></span> Logar</a></li>
