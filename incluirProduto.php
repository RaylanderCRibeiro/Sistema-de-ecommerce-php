...
try {
    ...
    $inserir = $conexao->query("INSERT INTO produtos (produto, marca, descricao, departamento, secao, quantidade, preco, foto1, foto2, foto3) VALUES ('$recebe_produto',
    '$recebe_marca', '$recebe_descricao', '$recebe_departamento', '$recebe_secao', '$recebe_quantidade', '$recebe_preco', '$img_nome1', '$img_nome2', '$img_nome3')");
