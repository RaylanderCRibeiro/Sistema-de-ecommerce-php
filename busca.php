...
<body>
	...
	$consulta = $conexao->query("SELECT * FROM produtos WHERE produto LIKE CONCAT ('%','$recebe_busca','%') OR descricao LIKE CONCAT ('%','$recebe_busca','%')");
	...
	<div class="container-fluid">
		...
		?>
			...
			<div class="row" style="margin-top: 15px;">
				...
				<div class="col-sm-5">
					<h4 style="padding-top:20px"> <?php echo $exibe['produto']; ?> </h4>
				</div>
				<div class="col-sm-2">
					<h4 style="padding-top:20px">R$ <?php echo number_format($exibe['preco'], 2, ',', '.'); ?> </h4>
				</div>
